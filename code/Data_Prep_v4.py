...
demo = spark.table('.hds_curated_assets__demographics_2024_04_25')
demo = (
    demo
...
gp_all = spark.table('.gdppr__archive')
...
pop_cnt.write.mode("overwrite").saveAsTable(".ccu008_popu_cnt_20240703D")
...
rf_cnt.write.mode("overwrite").saveAsTable(".ccu008_rf_cnt_20240710")
