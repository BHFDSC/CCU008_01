...
gp_raw = spark.table('.gdppr__archive')
...
save_checkpoint(df_in=gp_bmi  , database="", temp_df="ccu008_pop_bmi_fh_160623"  , global_view_name="ccu008")
save_checkpoint(df_in=gp_cig  , database="", temp_df="ccu008_pop_cig_fh_160623"  , global_view_name="ccu008")
save_checkpoint(df_in=gp_alco , database="", temp_df="ccu008_pop_alco_fh_160623" , global_view_name="ccu008")
save_checkpoint(df_in=gp_sbp  , database="", temp_df="ccu008_pop_sbp_fh_160623"  , global_view_name="ccu008")
save_checkpoint(df_in=gp_dbp  , database="", temp_df="ccu008_pop_dbp_fh_160623"  , global_view_name="ccu008")
save_checkpoint(df_in=gp_fg   , database="", temp_df="ccu008_pop_fg_fh_160623"   , global_view_name="ccu008")
save_checkpoint(df_in=gp_a1c  , database="", temp_df="ccu008_pop_a1c_fh_160623"  , global_view_name="ccu008")
save_checkpoint(df_in=gp_chol , database="", temp_df="ccu008_pop_chol_fh_160623" , global_view_name="ccu008")
save_checkpoint(df_in=gp_hdl  , database="", temp_df="ccu008_pop_hdl_fh_160623"  , global_view_name="ccu008")
save_checkpoint(df_in=gp_ldl  , database="", temp_df="ccu008_pop_ldl_fh_160623"  , global_view_name="ccu008")
save_checkpoint(df_in=gp_tg   , database="", temp_df="ccu008_pop_tg_fh_160623"   , global_view_name="ccu008")
save_checkpoint(df_in=gp_ast  , database="", temp_df="ccu008_pop_ast_fh_160623"  , global_view_name="ccu008")
save_checkpoint(df_in=gp_alt  , database="", temp_df="ccu008_pop_alt_fh_160623"  , global_view_name="ccu008")
save_checkpoint(df_in=gp_ggt  , database="", temp_df="ccu008_pop_ggt_fh_160623"  , global_view_name="ccu008")
...
"""save_checkpoint(df_in=select_cohort(gp_bmi  ), database="", temp_df="ccu008_coh_bmi_fh_160623"  , global_view_name="ccu008")
save_checkpoint(df_in=select_cohort(gp_cig  ), database="", temp_df="ccu008_coh_cig_fh_160623"  , global_view_name="ccu008")
save_checkpoint(df_in=select_cohort(gp_alco ), database="", temp_df="ccu008_coh_alco_fh_160623" , global_view_name="ccu008")
save_checkpoint(df_in=select_cohort(gp_sbp  ), database="", temp_df="ccu008_coh_sbp_fh_160623"  , global_view_name="ccu008")
save_checkpoint(df_in=select_cohort(gp_dbp  ), database="", temp_df="ccu008_coh_dbp_fh_160623"  , global_view_name="ccu008")
save_checkpoint(df_in=select_cohort(gp_fg   ), database="", temp_df="ccu008_coh_fg_fh_160623"   , global_view_name="ccu008")
save_checkpoint(df_in=select_cohort(gp_a1c  ), database="", temp_df="ccu008_coh_a1c_fh_160623"  , global_view_name="ccu008")
save_checkpoint(df_in=select_cohort(gp_chol ), database="", temp_df="ccu008_coh_chol_fh_160623" , global_view_name="ccu008")
save_checkpoint(df_in=select_cohort(gp_hdl  ), database="", temp_df="ccu008_coh_hdl_fh_160623"  , global_view_name="ccu008")
save_checkpoint(df_in=select_cohort(gp_ldl  ), database="", temp_df="ccu008_coh_ldl_fh_160623"  , global_view_name="ccu008")
save_checkpoint(df_in=select_cohort(gp_tg   ), database="", temp_df="ccu008_coh_tg_fh_160623"   , global_view_name="ccu008")
save_checkpoint(df_in=select_cohort(gp_ast  ), database="", temp_df="ccu008_coh_ast_fh_160623"  , global_view_name="ccu008")
save_checkpoint(df_in=select_cohort(gp_alt  ), database="", temp_df="ccu008_coh_alt_fh_160623"  , global_view_name="ccu008")
save_checkpoint(df_in=select_cohort(gp_ggt  ), database="", temp_df="ccu008_coh_ggt_fh_160623"  , global_view_name="ccu008")"""
...
drop_checkpoint(database="", temp_df="ccu008_pop_cig_fh_020323")
drop_checkpoint(database="", temp_df="ccu008_pop_alco_fh_020323")
drop_checkpoint(database="", temp_df="ccu008_pop_sbp_fh_020323")
drop_checkpoint(database="", temp_df="ccu008_pop_dbp_fh_020323")
drop_checkpoint(database="", temp_df="ccu008_pop_fg_fh_020323")
drop_checkpoint(database="", temp_df="ccu008_pop_a1c_fh_020323")
drop_checkpoint(database="", temp_df="ccu008_pop_chol_fh_020323")
drop_checkpoint(database="", temp_df="ccu008_pop_hdl_fh_020323")
drop_checkpoint(database="", temp_df="ccu008_pop_ldl_fh_020323")
drop_checkpoint(database="", temp_df="ccu008_pop_tg_fh_020323")
drop_checkpoint(database="", temp_df="ccu008_pop_ast_fh_020323")
drop_checkpoint(database="", temp_df="ccu008_pop_alt_fh_020323")
drop_checkpoint(database="", temp_df="ccu008_pop_ggt_fh_020323")

drop_checkpoint(database="", temp_df="ccu008_ca2_bmi_fh_020323")
drop_checkpoint(database="", temp_df="ccu008_ca2_cig_fh_020323")
drop_checkpoint(database="", temp_df="ccu008_ca2_alco_fh_020323")
drop_checkpoint(database="", temp_df="ccu008_ca2_sbp_fh_020323")
drop_checkpoint(database="", temp_df="ccu008_ca2_dbp_fh_020323")
drop_checkpoint(database="", temp_df="ccu008_ca2_fg_fh_020323")
drop_checkpoint(database="", temp_df="ccu008_ca2_a1c_fh_020323")
drop_checkpoint(database="", temp_df="ccu008_ca2_chol_fh_020323")
drop_checkpoint(database="", temp_df="ccu008_ca2_hdl_fh_020323")
drop_checkpoint(database="", temp_df="ccu008_ca2_ldl_fh_020323")
drop_checkpoint(database="", temp_df="ccu008_ca2_tg_fh_020323")
drop_checkpoint(database="", temp_df="ccu008_ca2_ast_fh_020323")
drop_checkpoint(database="", temp_df="ccu008_ca2_alt_fh_020323")
drop_checkpoint(database="", temp_df="ccu008_ca2_ggt_fh_020323")
